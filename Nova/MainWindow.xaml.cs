    ...
    public partial class MainWindow : Window
    {
        ...
        private void CleanupTempButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Task.Run(() =>
            {
                ...
                {
                    Dispatcher.Invoke(() => MessageBox.Show("No temporary files were found to clean.", "Nothing to Clean", MessageBoxButton.OK, MessageBoxImage.Information));
                    return;
                }

                SafeCleanupAsync("temporary files", tempFiles, "Temporary").GetAwaiter().GetResult();
            });
        }
        ...
        private void CleanupLargeButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Task.Run(() =>
            {
                ...
                SafeCleanupAsync("large files", files, "Large").GetAwaiter().GetResult();
            });
        }
        ...
        private void CleanupRecycleButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var result = MessageBox.Show(
                "This will empty the Recycle Bin for all drives. Continue?",
        ...
        private static void OpenUri(string uri)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Windows Tool Failed", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void LoadDriveReports()
        {
            ...
            foreach (var drive in DriveInfo.GetDrives().Where(d => d.IsReady && d.DriveType == DriveType.Fixed))
            {
                ...
                DriveReports.Add(new DriveReport(drive.Name, percent, used, free, total));
            }
        ...
        private List<CleanupItem> GetTempFiles()
        {
            ...
            return files.OrderByDescending(f => f.Size).Take(20).ToList();
        }
